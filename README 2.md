# Claude Chat v17（开源版 · 心跳版）使用说明

## 这是什么

一个 AI 对话前端，单个 HTML 文件，双击打开即可在本地使用，也可以部署到服务器供多人访问。支持 Claude（Anthropic）和任何 OpenAI 兼容接口，可选接入蓝牙玩具控制，并可选接入自建的「心跳唤醒」后端，让 AI 在你没说话的时候也能隔一段时间主动通过 Bark 推送给你发消息。
